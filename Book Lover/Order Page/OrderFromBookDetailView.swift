...
struct OrderFromBookDetailView: View {
...
struct OrderFromBookDetailView_Previews: PreviewProvider {
    static var previews: some View {
        OrderFromBookDetailView(orderItem:  .constant(testOrderItem), presentSheet: .constant(true), newOrder: .constant(false)).environmentObject(OrderModel())
    }
}
